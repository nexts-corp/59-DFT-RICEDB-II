...
var schema = {
    ...
    "required": ["id", "continent_name_th", "continent_name_en"]
};
...
router.get('/id/:continent_id', function (req, res, next) {
    db.query(function (conn) {
        r.db('common').table("continent")
            .get(req.params.continent_id)
            .merge({
...
router.post('/insert', function (req, res, next) {
    ...
    if (valid) {
        datacontext.insert("common", "continent", req.body, res);
    } else {
...
router.put('/update', function (req, res, next) {
    ...
    var result = { result: false, message: null, id: null };
    if (valid) {
        datacontext.update("common", "continent", req.body, res);
    } else {
        result.message = ajv.errorsText(validate.errors);
        res.json(result);
    }
...
router.delete('/delete/id/:id', function (req, res, next) {
    datacontext.delete("common", "continent", req.params.id, res);
});
